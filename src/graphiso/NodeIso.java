...
//CHECKS WHETHER TWO NODES OF SAME GRAPH IS ISOMORPHIC OR NOT
public class NodeIso {
    public static boolean checkNodeIso(int[][] graph, int node1, int node2) {
        ...
        //LOGIC:
        //CHECKS IF INTERCHANGING NODE's value, retain adjacency matrix.
        //Condition: All other nodes retain their position in matrix.
        //Verified procedure
