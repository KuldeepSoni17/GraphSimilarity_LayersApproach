...
//        System.out.println("DONE WITH BASE");
        ...
        while(testcnt-- > 0) {
            ...
            int[][] graph = permute_graph(basegraph, permute_generator(basegraph.length));
...
//                 System.out.println("BASE_GRAPH_OVER");
    ...
    public static int[][] permute_graph(int[][] basegraph, ArrayList<Integer> integers)
    {
        ...
        for(int i=0;i<basegraph.length;i++)
        {
            for(int j=0;j<basegraph.length;j++)
            {
//                System.out.print(newnewgraph[i][j]);
            }
//            System.out.println();
        }
        return newnewgraph;
    ...
    public static boolean matchlabels(String[] labels1, String[] labels2)
    {
        ...
        {
//         System.out.println(labels1[i]);
        }
        for(int i=0;i<labels2.length;i++)
        {
//            System.out.println(labels2[i]);
        }
        for(int i=0;i<labels1.length;i++) {
...
//        {
//            System.out.println(blabeltaken[i] + " ");
//            if(!blabeltaken[i]){System.out.println(labels1[i]);}
//        }
//        System.out.println();
//        for(int i=0;i<ilabeltaken.length;i++)
//        {
//            System.out.println(ilabeltaken[i] + " ");
//            if(!ilabeltaken[i]){System.out.println(labels2[i]);}
//        }
//        System.out.println();
...
//        System.out.print(label.layers.size() + " ");
        //complexity - 3n^4 + cn^2 + cn
        for(int i=0;i<label.layers.size();i++)
        {
            layer layer = label.layers.get(i);
//            System.out.print(layer.nodes.size() + " " + layer.incoming_edges.size() + " " + layer.outgoing_edges.size() + " " + layer.internal_edges.size() + " ");
            ...
            {
                //              System.out.print(layer.nodes.get(j).rank_top_down + " " + layer.nodes.get(j).rank_bottom_up + " ");
                res += layer.nodes.get(j).rank_top_down + " " + layer.nodes.get(j).rank_bottom_up + " ";
                //               System.out.print(layer.nodes.get(j).inc_edges.size() + " " + layer.nodes.get(j).out_edges.size() + " " + layer.nodes.get(j).int_edges.size() + " ");
                ...
                {
                    //                   System.out.print(layer.nodes.get(j).inc_edges.get(k).node1.rank_top_down + " " + layer.nodes.get(j).inc_edges.get(k).node1.rank_bottom_up + " ");
                ...
                {
                    //                   System.out.print(layer.nodes.get(j).out_edges.get(k).node1.rank_top_down + " " + layer.nodes.get(j).out_edges.get(k).node1.rank_bottom_up + " ");
                ...
                {
//                    System.out.print(layer.nodes.get(j).int_edges.get(k).node1.rank_top_down + " " + layer.nodes.get(j).int_edges.get(k).node1.rank_bottom_up + " ");
...
//            return false;
    ...
    {
        if(base_node_count==input_node_count)
        {
            System.out.println("NODE COUNT MATCH");
        }
    ...
    {
        if(base_edge_count==input_edge_count)
        {
            System.out.println("EDGE COUNT MATCH");
        }
    ...
    public static boolean matchdegreecount()
    {
        ...
        if(result)
        {
            System.out.println("DEGREE COUNT MATCH");
        }
        return result;
    }
...
//    public static int[][] inflatelayer(int graph_mat[][],int layer, int nodenum)
//    {
//        for(int i=0;i<base_node_count;i++)
//        {
//            if(basegraph[nodenum][i]==1)
//            {
//                graph_mat[layer][(graph_mat[layer][base_node_count+1])++] = i;
//            }
//        }
//        return graph_mat;
//    }
...
//        int layers_count;
//        //LAYER INFO.......1.node count, 2.incoming nodes from upper layer, 3.outgoing nodes to lower layer, 4.internal edges in layer
...
//                System.out.println();
//                System.out.println(layer.incoming_edges.size() + " " + layer.outgoing_edges.size() + " " + layer.internal_edges.size());
            }
