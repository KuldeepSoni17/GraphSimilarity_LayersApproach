...
public class TestClass {
    ...
    //complexity - n^2 + n + c
    public static boolean matchlabels(int[][] basegraph, int[][] inputgraph,String[] labels1, String[] labels2,ArrayList permutes)
    {
...
//            //complexity - c
        ...
        public void process_layer(layer layer)
        {
            ...
            for(int i=0;i<nodes.size();i++)
            {
                ...
                nodes.get(i).inc_edges.sort(new Comparator<nodeedge>() {
                    ...
                    public int compare(nodeedge o1, nodeedge o2) {
                        long x = ((o1.node1.rank_top_down%modulo + prime_provider.getprime(23)%modulo)%modulo * (o1.node1.rank_bottom_up%modulo + prime_provider.getprime(13)%modulo)%modulo)%modulo;
                        long y = ((o2.node1.rank_top_down%modulo + prime_provider.getprime(23)%modulo)%modulo * (o2.node1.rank_bottom_up%modulo+ prime_provider.getprime(13)%modulo)%modulo)%modulo;
                        return (int)(x - y);
                    }
                });
                //complexity - n^2*n^2
            ...
            nodes.sort(new Comparator<node>() {
                ...
                public int compare(node o1, node o2) {
                    long x = ((o1.rank_top_down%modulo+ prime_provider.getprime(23)%modulo)%modulo * (o1.rank_bottom_up %modulo+ prime_provider.getprime(13)%modulo)%modulo)%modulo;
                    long y = ((o2.rank_top_down%modulo+ prime_provider.getprime(23)%modulo)%modulo * (o2.rank_bottom_up %modulo+ prime_provider.getprime(13)%modulo)%modulo)%modulo;
                    return (int)(x - y);
                }
            });
        }
        ...
        {
            //complexity - 2c
            TestClass.layer layer = new TestClass.layer();
            layer.layer_no = layer_no;
            TestClass.node[] nextlay_nodes = new TestClass.node[base_node_count];
...
//                            writer.println("TWO " + layers.get(layer_no-1).nodes.get(i).ori_node_num + " " + j + " ");
                            ...
                            {
                                node = new TestClass.node(layer_no - 1, layer.nodes.size(), j);
                            ...
                            TestClass.edge edge = new TestClass.edge(layers.get(layer_no-1).nodes.get(i).pos_row, layers.get(layer_no-1).nodes.get(i).pos_col, node.pos_row,node.pos_col,layers.get(layer_no-1).nodes.get(i), node);
                            layer.incoming_edges.add(edge);
                            layers.get(layer_no-1).outgoing_edges.add(edge);
                            layers.get(layer_no-1).nodes.get(i).out_edges.add(new TestClass.nodeedge(node));
                            node.inc_edges.add(new TestClass.nodeedge(layers.get(layer_no-1).nodes.get(i)));
                        }
                        else {
...
//                                    writer.println("SAME LAYER");
                                    ...
                                    //complexity - 2c
                                    TestClass.edge edge = new TestClass.edge(layers.get(layer_no - 1).nodes.get(k).pos_row, layers.get(layer_no - 1).nodes.get(k).pos_col, layers.get(layer_no - 1).nodes.get(i).pos_row, layers.get(layer_no - 1).nodes.get(i).pos_col, layers.get(layer_no - 1).nodes.get(k),layers.get(layer_no - 1).nodes.get(i));
...
//                                        writer.println("NOT REPEAT");
                                        ...
                                        {
                                            layers.get(layer_no - 1).nodes.get(k).int_edges.add(new TestClass.nodeedge(layers.get(layer_no - 1).nodes.get(i)));
                                        }
                                        else
                                        {
                                            layers.get(layer_no - 1).nodes.get(k).int_edges.add(new TestClass.nodeedge(layers.get(layer_no - 1).nodes.get(i)));
                                            layers.get(layer_no - 1).nodes.get(i).int_edges.add(new TestClass.nodeedge(layers.get(layer_no - 1).nodes.get(k)));
                                        }
...
//            writer.print("COMPLETED INFLATING" + layers.size() + " ");
        ...
        {   String temp = new String();
            ...
            {   int curr_prime1=0;
                //complexity - c
                TestClass.layer curr_layer = layers.get(a);

                //complexity - n
                ArrayList<TestClass.node> nodes = (ArrayList<TestClass.node>)curr_layer.nodes.clone();
                ...
                {
                    long o1_cnt = 1;
                    TestClass.node o1 = nodes.get(lp);
                    for(int aa=0;aa<o1.out_edges.size();aa++)
                    {
//                        writer.println("MULT_1*((2*3) + (4*5))" + o1_cnt + " " + (o1.out_edges.get(aa).node1.rank_top_down) + " " + TestClass.prime_provider.getprime(99) + " " + (o1.out_edges.get(aa).node1.rank_bottom_up) + " " + TestClass.prime_provider.getprime(97) + " " + o1.ori_node_num + " " + o1.out_edges.get(aa).node1.ori_node_num);
                        o1_cnt = (o1_cnt%modulo * (((o1.out_edges.get(aa).node1.rank_top_down)%modulo*(TestClass.prime_provider.getprime(99))%modulo)%modulo + ((o1.out_edges.get(aa).node1.rank_bottom_up)%modulo*(TestClass.prime_provider.getprime(97))%modulo)%modulo)%modulo)%modulo;
                    }
                    o1.curr_cnt = o1_cnt;
                }
                nodes.sort(new Comparator<TestClass.node>() {
                    @Override
                    public int compare(TestClass.node o1, TestClass.node o2) {
...
//                //complexity - 3c
                ...
                nodes.get(0).rank_bottom_up = TestClass.prime_provider.getprime(curr_prime1);

                //complexity - n
                for(int x =1;x<curr_layer.nodes.size();x++)
                {
                    if(curr_num==nodes.get(x).curr_cnt) {nodes.get(x).rank_bottom_up = TestClass.prime_provider.getprime(curr_prime1);}
                    else {curr_num = nodes.get(x).curr_cnt;nodes.get(x).rank_bottom_up = TestClass.prime_provider.getprime(++curr_prime1);}}
...
//                    writer.println(nodes.get(zx).int_edges.size() + " ");
                    ...
                    {
                        nodes.get(zx).curr_cnt = (nodes.get(zx).curr_cnt%modulo * (((nodes.get(zx).int_edges.get(zy).node1.rank_top_down)%modulo*(TestClass.prime_provider.getprime(99))%modulo)%modulo + ((nodes.get(zx).int_edges.get(zy).node1.rank_bottom_up)%modulo*(TestClass.prime_provider.getprime(97))%modulo)%modulo)%modulo)%modulo;
//                        writer.println("MULT" + nodes.get(zx).curr_cnt + "*(" + nodes.get(zx).int_edges.get(zy).node1.rank_top_down + "*" + TestClass.prime_provider.getprime(99) +" " + nodes.get(zx).int_edges.get(zy).node1.rank_bottom_up + "*" + TestClass.prime_provider.getprime(97) + " " +  nodes.get(zx).ori_node_num + " " + nodes.get(zx).int_edges.get(zy).node1.ori_node_num);
                    }
                }
                ArrayList<TestClass.node> nodes_sec = (ArrayList<TestClass.node>)nodes.clone();
                //complexity - n^2
                nodes_sec.sort(new Comparator<TestClass.node>() {@Override public int compare(TestClass.node o1, TestClass.node o2) {
                    return (int)(o2.curr_cnt-o1.curr_cnt);
                }});
                ...
                curr_prime1++;
//                writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime1) + " " + nodes_sec.get(0).rank_bottom_up  + " " + nodes_sec.get(0).ori_node_num);
                nodes_sec.get(0).rank_bottom_up = ((nodes_sec.get(0).rank_bottom_up)%modulo * (TestClass.prime_provider.getprime(curr_prime1))%modulo)%modulo;
                ...
                for(int x =1;x<curr_layer.nodes.size();x++)
                {
                    ...
                    {
//                        writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime1) + " " + nodes_sec.get(x).rank_bottom_up + " " + nodes_sec.get(x).ori_node_num);
                        nodes_sec.get(x).rank_bottom_up = ((nodes_sec.get(x).rank_bottom_up)%modulo * (TestClass.prime_provider.getprime(curr_prime1))%modulo)%modulo;
                    }
                    else
                    {
                        curr_num = nodes_sec.get(x).curr_cnt;
//                        writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime1+1) + " " + nodes_sec.get(x).rank_bottom_up + " " + nodes_sec.get(x).ori_node_num);
                        nodes_sec.get(x).rank_bottom_up = ((nodes_sec.get(x).rank_bottom_up)%modulo * (TestClass.prime_provider.getprime(++curr_prime1))%modulo)%modulo;
                    }
                }
                for(int x =0;x<curr_layer.nodes.size();x++)
...
//                        writer.println("MULT" + nodes_sec.get(zx).inc_edges.get(zy).node1.rank_top_down + " " + nodes_sec.get(zx).curr_cnt  + " " + nodes_sec.get(zx).ori_node_num + " " + nodes_sec.get(zx).inc_edges.get(zy).node1.ori_node_num);
                ...
                nodes_sec.sort(new Comparator<TestClass.node>() {
                    @Override
                    public int compare(TestClass.node o1, TestClass.node o2) {
                        return (int)(o2.curr_cnt-o1.curr_cnt);
                    }
                ...
                curr_prime1++;
//                writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime1) + " " + nodes_sec.get(0).rank_bottom_up  + " " + nodes_sec.get(0).ori_node_num);
                nodes_sec.get(0).rank_bottom_up = (nodes_sec.get(0).rank_bottom_up%modulo* TestClass.prime_provider.getprime(curr_prime1)%modulo);
...
//                    writer.println(nodes_sec.get(x).rank_bottom_up + " " + nodes_sec.get(x).curr_cnt + " " + a  + " " + nodes_sec.get(x).ori_node_num);
        ...
        public String rank_bottom_up_bottom()
        {
            String temp = new String();
            //complexity - c
            TestClass.layer bottom_layer = layers.get(layers.size()-1);
            //complexity - n
            ArrayList<TestClass.node> nodes = (ArrayList<TestClass.node>)bottom_layer.nodes.clone();
...
//                    writer.println("MULT" + nodes.get(x).int_edges.get(y).node1.rank_top_down + " " + nodes.get(x).curr_cnt  + " " + nodes.get(x).ori_node_num + " " + nodes.get(x).int_edges.get(y).node1.ori_node_num);
            ...
            nodes.get(0).rank_bottom_up = TestClass.prime_provider.getprime(curr_prime_index);
            ...
            for(int x =1;x<bottom_layer.nodes.size();x++)
            {
                ...
                {
                    nodes.get(x).rank_bottom_up = TestClass.prime_provider.getprime(curr_prime_index);
                }
                else
                {
...
//                    writer.println("MULT" + nodes.get(x).inc_edges.get(y).node1.rank_top_down + " " + nodes.get(x).curr_cnt  + " " + nodes.get(x).ori_node_num + " " + nodes.get(x).inc_edges.get(y).node1.ori_node_num);
            ...
            for(int x =1;x<bottom_layer.nodes.size();x++)
            {
                if(curr_num==nodes.get(x).curr_cnt)
                {
//                    writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime_index) + " " + nodes.get(x).rank_bottom_up + " " + nodes.get(x).ori_node_num);
                    nodes.get(x).rank_bottom_up = (nodes.get(x).rank_bottom_up%modulo * TestClass.prime_provider.getprime(curr_prime_index)%modulo)%modulo;
                }
                else
                {
                    curr_num = (int)nodes.get(x).curr_cnt;
//                    writer.println("MULT" + TestClass.prime_provider.getprime(curr_prime_index+1) + " " + nodes.get(x).rank_bottom_up + " " + nodes.get(x).ori_node_num);
                    nodes.get(x).rank_bottom_up = ( nodes.get(x).rank_bottom_up%modulo * TestClass.prime_provider.getprime(++curr_prime_index)%modulo)%modulo;
                }
            }
...
//                writer.println(nodes.get(x).rank_bottom_up + " " + nodes.get(x).curr_cnt + " " + (layers.size()-1) + " " + nodes.get(x).ori_node_num);
        ...
        {//complexity - 2c
            ...
            for(int a = 1;a<layers.size();a++)
            {
                ...
                //complexity - 3c
                long curr_num = nodes.get(0).curr_cnt;
                nodes.get(0).rank_top_down = TestClass.prime_provider.getprime(curr_prime);
                ...
                for(int x =1;x<curr_layer.nodes.size();x++)
                {
                    if(curr_num==nodes.get(x).curr_cnt)
                    {
                        nodes.get(x).rank_top_down = TestClass.prime_provider.getprime(curr_prime);
                    }
                    else
                    {
                ...
                //writer.println("MULT" + nodes_sec.get(0).rank_top_down + " " + TestClass.prime_provider.getprime(curr_prime)  + " " + nodes_sec.get(0).ori_node_num);
                nodes_sec.get(0).rank_top_down = (nodes_sec.get(0).rank_top_down%modulo * TestClass.prime_provider.getprime(curr_prime)%modulo)%modulo;
                ...
                for(int x =1;x<curr_layer.nodes.size();x++)
                {
                    if(curr_num==nodes_sec.get(x).curr_cnt)
                    {
                        //      writer.println("MULT" + nodes_sec.get(x).rank_top_down + " " + TestClass.prime_provider.getprime(curr_prime)  + " " + nodes_sec.get(x).ori_node_num);
                        nodes_sec.get(x).rank_top_down = (nodes_sec.get(x).rank_top_down%modulo * TestClass.prime_provider.getprime(curr_prime)%modulo)%modulo;
                    }
                    else
                    {
                        curr_num = nodes_sec.get(x).curr_cnt;
                        //writer.println("MULT" + nodes_sec.get(x).rank_top_down + " " + TestClass.prime_provider.getprime(curr_prime+1)  + " " + nodes_sec.get(x).ori_node_num);
                        nodes_sec.get(x).rank_top_down = (nodes_sec.get(x).rank_top_down%modulo * TestClass.prime_provider.getprime(++curr_prime)%modulo)%modulo;
                    }
                }
                for(int x =0;x<curr_layer.nodes.size();x++)
...
//                    writer.println(nodes_sec.get(x).rank_top_down + " " + nodes_sec.get(x).curr_cnt + " " + a  + " " + nodes_sec.get(x).ori_node_num);
        ...
        {
            TestClass.layer top_layer = layers.get(0);
            top_layer.nodes.get(0).rank_top_down = TestClass.prime_provider.getprime(0);
        }
    }
